...
var qnt = document.querySelector('.qnt-caracteres');
...
function gera() {
  var senha = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(qnt.value, chkMinusculas.checked, chkMaiusculas.checked, chkNumeros.checked, chkSimbolos.checked);
...
var geraSenha = function geraSenha(qnt, minuscula, maiuscula, numero, simbolo) {
  var senhaArray = [];
  qnt = Number(qnt);
  console.log(qnt);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --primary-color: rgb(13, 163, 173);\n  --primary-color-darker: rgb(4, 65, 70);\n}\n\n* {\n  box-sizing: border-box;\n  outline: none;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background-color: var(--primary-color);\n  font-family: \"Open Sans\", sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n.container {\n  max-width: 600px;\n  background: #fff;\n  margin: 50px auto;\n  padding: 20px;\n  border-radius: 10px;\n}\n\nform input,\nform label,\nform button {\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\ninput:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nbutton {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700px;\n  padding: 10px;\n  cursor: pointer;\n  margin-top: 30px;\n  border-radius: 10px;\n}\n\nbutton:hover {\n  background: var(--primary-color-darker);\n}\n\n.senha-gerada {\n  font-size: 28px;\n  color: var(--primary-color-darker);\n  margin: 40px 0;\n}\n\ninput[type=\"number\"] {\n  width: 50px;\n}\n\ninput[type=\"checkbox\"] {\n  width: 20px;\n  height: 20px;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAEA;EACE,kCAAkC;EAClC,sCAAsC;AACxC;;AAEA;EACE,sBAAsB;EACtB,aAAa;AACf;;AAEA;EACE,SAAS;EACT,UAAU;EACV,sCAAsC;EACtC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;AACA;EACE,gBAAgB;EAChB,gBAAgB;EAChB,iBAAiB;EACjB,aAAa;EACb,mBAAmB;AACrB;;AAEA;;;EAGE,cAAc;EACd,WAAW;EACX,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,eAAe;AACjB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,YAAY;EACZ,gCAAgC;EAChC,WAAW;EACX,eAAe;EACf,kBAAkB;EAClB,aAAa;EACb,eAAe;EACf,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,uCAAuC;AACzC;;AAEA;EACE,eAAe;EACf,kCAAkC;EAClC,cAAc;AAChB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,WAAW;EACX,YAAY;AACd","sourcesContent":["@import url(\"https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;700&display=swap\");\n\n:root {\n  --primary-color: rgb(13, 163, 173);\n  --primary-color-darker: rgb(4, 65, 70);\n}\n\n* {\n  box-sizing: border-box;\n  outline: none;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background-color: var(--primary-color);\n  font-family: \"Open Sans\", sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n.container {\n  max-width: 600px;\n  background: #fff;\n  margin: 50px auto;\n  padding: 20px;\n  border-radius: 10px;\n}\n\nform input,\nform label,\nform button {\n  display: block;\n  width: 100%;\n  margin-bottom: 10px;\n}\n\nform input {\n  font-size: 24px;\n  height: 50px;\n  padding: 0 20px;\n}\n\ninput:focus {\n  outline: 1px solid var(--primary-color);\n}\n\nbutton {\n  border: none;\n  background: var(--primary-color);\n  color: #fff;\n  font-size: 18px;\n  font-weight: 700px;\n  padding: 10px;\n  cursor: pointer;\n  margin-top: 30px;\n  border-radius: 10px;\n}\n\nbutton:hover {\n  background: var(--primary-color-darker);\n}\n\n.senha-gerada {\n  font-size: 28px;\n  color: var(--primary-color-darker);\n  margin: 40px 0;\n}\n\ninput[type=\"number\"] {\n  width: 50px;\n}\n\ninput[type=\"checkbox\"] {\n  width: 20px;\n  height: 20px;\n}\n"],"sourceRoot":""}]);
// Exports
